...
from app.plugins.plugin_factory._tool_factory_common import coalesce_tool_file_target, extra_root_or_error
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "openai_tool_name": {
                        "type": "string",
                        "description": "Exact OpenAI function name (e.g. fishing_index) if the module lives under AGENT_PLUGINS_EXTRA_DIR",
                    },
